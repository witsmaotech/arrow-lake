...
ARROW_LAKE_KG_SCHEMA = GraphSchema(
    ...
    edge_labels=(
        ...
        EdgeLabelDef("part_of", "entity", "entity"),
        EdgeLabelDef("belongs_to", "person", "organization"),
        EdgeLabelDef("located_in", "person", "location"),
        EdgeLabelDef("participates_in", "person", "event"),
        EdgeLabelDef("depicts", "event", "entity"),
    ),
    index_labels=(
